...
class API: NSObject
{
    class func callDictionaryAPI(webserviceFor:String, webMethod: HTTPMethod, parameters:[String:Any],completion:@escaping (_ error:Error?,_ task:Any?)->Void)
    {
        ...
        } else if (webserviceFor == StringIdentifiers.send_password || webserviceFor == StringIdentifiers.make_register || webserviceFor == StringIdentifiers.edit_user || webserviceFor == StringIdentifiers.add_address || webserviceFor == StringIdentifiers.sendPrivateMessages || webserviceFor == StringIdentifiers.change_password || webserviceFor == StringIdentifiers.make_order || webserviceFor == StringIdentifiers.edit_address || webserviceFor == StringIdentifiers.contactUsRequest || webserviceFor == StringIdentifiers.product_add_cart || webserviceFor == StringIdentifiers.product_edit_cart || webserviceFor == StringIdentifiers.token || webserviceFor == StringIdentifiers.postIssue){
        ...
        if (webserviceFor==StringIdentifiers.make_register || webserviceFor==StringIdentifiers.edit_user || webserviceFor==StringIdentifiers.add_address || webserviceFor==StringIdentifiers.make_order || webserviceFor==StringIdentifiers.edit_address || webserviceFor==StringIdentifiers.contactUsRequest || webserviceFor==StringIdentifiers.edit_address || webserviceFor==StringIdentifiers.product_add_cart || webserviceFor==StringIdentifiers.product_edit_cart || webserviceFor == StringIdentifiers.sendPrivateMessages || webserviceFor == StringIdentifiers.postIssue) {
        ...
        if (webserviceFor==StringIdentifiers.make_register || webserviceFor==StringIdentifiers.edit_user || webserviceFor==StringIdentifiers.add_address || webserviceFor==StringIdentifiers.make_order || webserviceFor==StringIdentifiers.edit_address || webserviceFor==StringIdentifiers.contactUsRequest || webserviceFor==StringIdentifiers.product_add_cart || webserviceFor==StringIdentifiers.product_edit_cart || webserviceFor == StringIdentifiers.sendPrivateMessages || webserviceFor == StringIdentifiers.postIssue) {
